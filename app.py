# app.py  ── STYLED VERSION (logic untouched)
# ✅  Utility imports moved inside run() to prevent CSS-leaking bug.
...
def run():
    # ── Lazy imports: MUST stay inside run(), not at module top-level ──
    ...
    # ════════════════════════════════════════════════════════════════
    #  ORIGINAL APP LOGIC — completely unchanged
    # ════════════════════════════════════════════════════════════════
